...
;=============================================================
				;Led acceso    dato che lo converto in binario, 01, e quindi accende il primo led 
LED_OFF EQU	    00	
			  ; Led spento   in binario esce 10 quindi spegne il led 0 e accende il led 1
;=============================================================
;       AREA DATI
;=============================================================	
;LABEL	CODE 	OPERANDO	COMMENTO
...
accendi	
		movlw   3
		movwf CONTA
		movlw   LED_OFF				  ; sposta in W il valore di LED_ON
		movwf	PORTB				  ; invio in uscita sulla Porta B, B0=1  
loop	call 	delay
		incf    PORTB
		decfsz  CONTA					;devo testare se bit 2 va a 1, se è settato. Se vale 1 vado su goto accendi. 
		goto 	loop	
		goto 	accendi				
